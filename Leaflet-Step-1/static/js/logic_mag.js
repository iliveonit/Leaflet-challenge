...
//  Color coding .... 
// Function that will determine the color of a earthquake based on the magnitude 
...
d3.json(queryUrl, function(data) {
  ...
  L.geoJson(data, {
    // Style each feature (in this case a coordinates)
    ...
    onEachFeature: function(feature, layer) {
      ...
      layer.on({
        ...
        // When a feature (coordinates) is clicked, it is enlarged to fit the screen
